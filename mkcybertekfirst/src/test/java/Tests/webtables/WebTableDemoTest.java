...
//import com.cybertek.tests.TestsBase;
//import com.cybertek.utilities.ConfigurationReaderrationReader;
...
//        }
    ...
    public void getWholeRow() {
        ...
        System.out.println("===");
        List<WebElement> rowsWithHeaders = driver.findElements(By.xpath("//table[@id='table1']//tr"));
        for (int i = 0; i < rowsWithHeaders.size() ; i++) {
            System.out.println(rowsWithHeaders.get(i).getText());
        }
    }
