package Tests.PracticeOnCybertek.SelfStudy.jse_and_actions;
...
public class ActionsTest {
    ...
    public void chainingActions() throws InterruptedException {
        ...
        //first element: Enabled
        WebElement firstOne = driver.findElement(By.id("ui-id-3"));
        //second element: Downloads
        WebElement secondOne = driver.findElement(By.id("ui-id-4"));
        //third element: PDF
        WebElement thirdOne = driver.findElement(By.id("ui-id-5"));
        //third element: Back to JQuery UI
//        WebElement thirdOne = driver.findElement(By.id("ui-id-8"));


//        actions.moveToElement(firstOne).pause(1000).moveToElement(secondOne).build().perform();

        actions.moveToElement(firstOne).pause(1000).moveToElement(secondOne).pause(1000).moveToElement(thirdOne).build().perform();
        Thread.sleep(1000);
        thirdOne.click();  //Click to PDF
